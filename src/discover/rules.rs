...
pub const RULES: &[RtkRule] = &[
    RtkRule {
        pattern: r"^(?:git|yadm)\s+(?:-[Cc]\s+\S+\s+)*(status|log|diff|show|add|commit|push|pull|branch|fetch|stash|worktree|grep|ls-tree|ls-files)",
        rtk_cmd: "rtk git",
    ...
    RtkRule {
        ...
        rtk_cmd: "rtk phpt",
        rewrite_prefixes: &["php run-tests.php", "php ./run-tests.php"],
        category: "Tests",
        savings_pct: 99.0,
        subcmd_savings: &[],
        subcmd_status: &[],
